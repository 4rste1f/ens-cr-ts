...
def main() -> None:
    ...
    parser.add_argument("--training-noise", "--noise", dest="noise", type=float, default=0.00)
    ...
    stem = f"heat_{args.simple}_{args.complex}_comparison"
