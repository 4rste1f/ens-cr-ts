...
|---|---:|---:|---:|---:|---:|---:|
| learned · fourier→pinnmamba · joint baseline | 15 | 0.246 | +0.099 [+0.047, +0.162] | 93% | +8.0% | +13.6% |
| learned · rbf→pinnmamba · joint baseline | 15 | 0.308 | +0.034 [+0.022, +0.046] | 87% | +4.0% | +6.7% |
| morse · rbf→pinnmamba · distill to simple | 15 | 0.529 | +0.012 [-0.005, +0.030] | 73% | +1.6% | +7.7% |

## Key observations

- **morse · rbf→pinnmamba · distill to simple has the smallest mean NSE drift** at noise `0.25` (+0.012).
- **learned · fourier→pinnmamba · joint baseline degrades more consistently:** its mean NSE loss is +0.099, about 8.0× larger, and 93% of basins degrade.
- **learned · fourier→pinnmamba · joint baseline:** mean KGE degrades by 0.042.
- **learned · rbf→pinnmamba · joint baseline:** mean KGE degrades by 0.011.
- **morse · rbf→pinnmamba · distill to simple:** mean KGE degrades by 0.002.

## Most noise-sensitive basins

- **learned · fourier→pinnmamba · joint baseline:** 4008 (+0.362 NSE), 2488 (+0.300 NSE), 4009 (+0.243 NSE)
- **learned · rbf→pinnmamba · joint baseline:** 4023 (+0.064 NSE), 4022 (+0.064 NSE), 3014 (+0.061 NSE)
- **morse · rbf→pinnmamba · distill to simple:** 2488 (+0.080 NSE), 4009 (+0.076 NSE), 3014 (+0.031 NSE)
...
- `/home/ubuntu/work/numba/ensemble_review_git/legendary-broccoli/artifacts/hydrology/distill_to_simple/15_basins_mamba_fourier/results.json`
